...
const Header = React.memo(() => {
  ...
  const getPageTitle = useMemo(() => {
   ...
   if (pathname === "/files") return "File Manager";
    ...
    if (pathname.includes("/sales")) return "Sales Pipeline";
    if (pathname.includes("/invoices")) return "Invoices";
    if (pathname.includes("/calendar")) return "Calendar";
    if (pathname.includes("/metrics")) return "Performance Metrics";
    if (pathname.includes("/services")) return "Services";
    if (pathname.includes("/blogs")) return "Blogs";
    if (pathname.includes("/templates")) return "Template Library";
    if (pathname.includes("/feedback")) return "Feedback Center";
    if (pathname.includes("/plans")) return "Plans & Discounts";
