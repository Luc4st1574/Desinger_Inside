...
type StageName = 'Prospecting' | 'Meeting' | 'Proposal' | 'Deal';
...
const stageIcons: { [key in StageName]: React.ReactElement } = {
    Prospecting: <Prospecting size={16} className="text-[#5e6b66]" />,
    Meeting: <Meeting size={16} className="text-[#5e6b66]" />,
    Proposal: <Proposal size={16} className="text-[#5e6b66]" />,
    Deal: <Deal size={16} className="text-[#5e6b66]" />,
};
...
const calculateMonthsSince = (sinceDateStr: string): number => {
    ...
    if (currentYear < sinceYear || (currentYear === sinceYear && currentMonth < sinceMonth)) {
      return 1;
    }
...
export default function ProspectsBoard({ onSetProspect }: ProspectsBoardProps) {
    // Assert the types of the imported JSON data to match your defined interfaces.
                            ...
                            >
                                <div className="flex flex-col space-y-3">
                                    ...
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        />
                                        <div>
                                            <p className="text-black text-sm leading-tight">{prospect.title}</p>
