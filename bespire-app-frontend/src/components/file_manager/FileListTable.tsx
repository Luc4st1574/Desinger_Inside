...
export default function FileListTable({ 
    ...
    selectedFiles, onSelectionChange, mode, onRestore, onPermanentDelete, workspaceId
}: FileListTableProps) {
    ...
    const handleOpen = async (file: MockFile) => {
        ...
        } else if (file.type === 'MS Word File' || file.type=='vnd.openxmlformats-officedocument.wordprocessingml.document') {
            try {
        ...
        if (file.type !== 'Folder') {
            actions.onDownload = async () => {
                ...
                try {
                    ...
                    showSuccessToast(`Archivo descargado correctamente: ${file.name}`);
                } catch (err) {
