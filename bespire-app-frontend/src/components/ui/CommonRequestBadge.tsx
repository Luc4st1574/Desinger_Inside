...
const CommonRequestBadge: React.FC<CommonRequestBadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center gap-2 text-green-gray-700 rounded-full font-medium transition-colors ${sizeClasses[size]} ${variantStyles.className} ${className}`}
