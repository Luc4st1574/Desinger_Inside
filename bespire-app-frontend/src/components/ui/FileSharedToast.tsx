...
// ✅ RENAMED & UPDATED: Added the `fileName` prop
interface FileSharedToastProps {
    toastId: string | number;
    fileName: string;
    onGoToChat: () => void;
}

// ✅ RENAMED & UPDATED: Component now accepts and uses `fileName`
export default function FileSharedToast({ toastId, fileName, onGoToChat }: FileSharedToastProps) {
    ...
    return (
        <div className="flex w-full max-w-lg items-center justify-between gap-4 rounded-xl border border-[#E2E6E4] bg-[#F1F3EE] px-4 py-3 text-base">
            <div className="flex items-center gap-3">
                ...
                <p className="font-medium text-[#181B1A] whitespace-nowrap">
                    &quot;{fileName}&quot; shared
                </p>
                <button
