...
type AppContextType = {
  ...
  setIsEditRequest: Dispatch<SetStateAction<boolean>>;
  requestForEdit: any;
  setRequestForEdit: Dispatch<SetStateAction<any>>;
  ...
  // Para manejar edición de archivos existentes
  editingFileId: string | null;
  setEditingFileId: Dispatch<SetStateAction<string | null>>;
  editingFileUrl: string | null;
  setEditingFileUrl: Dispatch<SetStateAction<string | null>>;
  chats: Chat[];
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  const [requestForEdit, setRequestForEdit] = useState<any>(null);
