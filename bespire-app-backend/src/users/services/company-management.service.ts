...
export class CompanyManagementService {
  ...
  private async createPasswordHash(password: string): Promise<string> {
    ...
    throw new Error('createPasswordHash should be injected from UserAuthService');
  }
  ...
  private async addTeamMemberToWorkspace(input: PreRegisterClientInput) {
    ...
    throw new Error('addTeamMemberToWorkspace should be injected from TeamManagementService');
  }
}
