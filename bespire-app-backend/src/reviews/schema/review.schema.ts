...
export class Review extends Document {
  ...
  @Field(() => ID)
  @Prop({ required: true, type: Types.ObjectId, refPath: 'linkedToType' }) // <--- USA refPath
  ...
  @Prop({
    required: true,
    type: String,
    enum: ['User', 'Request', 'Subtask', 'Brand', 'Other'], //debe coincidir con los nombres de los modelos
  })
  linkedToType: string;
