...
export class CloudinaryService {
  ...
  async uploadImage(file: Express.Multer.File): Promise<UploadApiResponse> {
    ...
    console.log('CloudinaryService: Starting upload for file:', file.originalname);
  ...
  private async uploadToLocal(file: Express.Multer.File): Promise<UploadApiResponse> {
    ...
    try {
      ...
      const baseUrl = this.configService.get('FRONTEND_URL') || 'http://localhost:4000';
